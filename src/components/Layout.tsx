          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center">
              <Link href="/" className="text-2xl font-bold text-indigo-600">
                CitizenProject<span className="inline-block w-1.5 h-1.5 bg-red-600 rounded-full animate-pulse mx-0.5"></span>App
              </Link>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Link
                href="/projects"
                className={`px-3 py-2 rounded-md text-sm font-medium ${currentPage === 'projects'
                  ? 'text-indigo-600 bg-indigo-50'
                  : 'text-gray-700 hover:text-indigo-600'
                  }`}
              >
              ...
              <div className="relative group">
                <button className={`px-3 py-2 rounded-md text-sm font-medium inline-flex items-center ${['dashboard', 'processes', 'templates', 'tasks', 'team', 'files'].includes(currentPage)
                  ? 'text-indigo-600 bg-indigo-50'
                  : 'text-gray-700 hover:text-indigo-600'
                  }`}>
                  Ressourcen
