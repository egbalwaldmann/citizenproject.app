    ...
    <Layout currentPage="dashboard">
      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
          ...
          <Link href="/setup" className="bg-indigo-600 p-6 rounded-lg shadow hover:bg-indigo-700 transition-colors flex items-center justify-center group">
            <div className="text-center">
              <div className="text-3xl text-white mb-2 group-hover:scale-110 transition-transform">🚀</div>
              <p className="text-white font-bold text-lg">Start New Project</p>
              <p className="text-indigo-100 text-sm">Launch wizard</p>
            </div>
          </Link>
        </div>
              ...
              <div className="space-y-4">
                {projects.map((project) => (
                  <div key={project.id} className="border rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-900 mt-2">👥 {project.team} team members</p>
                  </div>
                ))}
              </div>
              <div className="mt-6">
                  ...
                  <div key={task.id} className="border rounded-lg p-4">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-sm text-gray-900">{task.project}</p>
                      </div>
                    ...
                    <p className="text-sm text-gray-900 mt-2">Due: {task.dueDate}</p>
                  </div>
                ))}
              </div>
              <div className="mt-6">
